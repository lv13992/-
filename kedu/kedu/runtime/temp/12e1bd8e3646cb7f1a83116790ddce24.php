<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\xiaoshi\code\day09\xm\kedu\kedu\public/../application/admin\view\goods\edit.html";i:1524196729;s:78:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\layout.html";i:1524483225;s:76:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\menu.html";i:1524485564;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="" method="post" name="myfrom" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="goods_name" placeholder="商品名称" class="col-xs-10 col-sm-5" value="<?php echo $list['goods_name']; ?>"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="goods_sn" placeholder="商品货号" class="col-xs-10 col-sm-5" value="<?php echo $list['goods_sn']; ?>"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number"  value="<?php echo $list['shop_price']; ?>" name="shop_price" placeholder="本店售价" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">市场售价 </label>
                    <div class="col-sm-9">
                        <input type="number" value="<?php echo $list['market_price']; ?>" name="market_price" placeholder="市场售价" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">赠送消费积分数 </label>
                    <div class="col-sm-9">
                        <input type="number" name="give_integral" value="<?php echo $list['give_integral']; ?>"placeholder="赠送消费积分数" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">促销价 </label>
                    <div class="col-sm-9">
                        <input type="number" name="promote_price" value="<?php echo $list['promote_price']; ?>"placeholder="促销价" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">促销日期 </label>
                    <div class="col-sm-9">
                        <input type="date" name="promote_start_date" value="<?php echo date('Y-m-d',$list['promote_start_date']); ?>" placeholder="" class="col-xs-10 col-sm-5" />
                        <input type="date" name="promote_end_date"  value="<?php echo date('Y-m-d',$list['promote_end_date']); ?>" placeholder="" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">商品的简短描述 </label>
                    <div class="col-sm-9">
                        <input type="text" name="goods_brief" value="<?php echo $list['goods_brief']; ?>" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">商品详细描述 </label>
                    <div class="col-sm-9">
                        <textarea name="goods_desc" id="" cols="30" rows="10"><?php echo $list['goods_desc']; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
