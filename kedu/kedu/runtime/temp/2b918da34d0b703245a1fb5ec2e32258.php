<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"D:\xiaoshi\code\day09\xm\kedu\kedu\public/../application/admin\view\user_comment\index.html";i:1524446089;s:78:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\layout.html";i:1524529658;s:76:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\menu.html";i:1524537907;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="col-xs-12">
                    <table id="simple-table" class="table  table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><?php echo $val['comment_type']===0?'商品':'文章'; ?></td>
                            <td><?php echo $val['id_value']; ?></td>
                            <td class="hidden-480"><?php echo $val['email']; ?></td>
                            <td><?php echo $val['content']; ?></td>

                            <td class="hidden-480">
                                <span class="label label-sm label-warning"><?php echo $val['comment_rank']; ?></span>
                            </td>
                            <td><?php echo date('Y-m-d H:i:s',$val['add_time'] ); ?></td>
                            <td><?php echo $val['ip_address']; ?></td>
                            <td><?php echo $val['status']===0?'未批准':'已批准'; ?></td>
                            <td><?php echo $val['user_id']; ?></td>
                            <td>
                                <div class="hidden-sm hidden-xs btn-group">

                                    <?php if($val['status'] == 0): ?>
                                    <a href='<?php echo url("UserComment/edit",["id"=>$val['id']]); ?>'>
                                    <span class="btn btn-xs btn-info">
                                                <i class="ace-icon fa fa-pencil bigger-120"></i>
                                            </span>
                                    </a>
                                    <?php endif; ?>
                                    <a href='javascript:void(0)' onclick="return alert_del('<?php echo url("del",["id"=>$val['id']]); ?>', '确认要删除『id=<?php echo $val['id']; ?>  』这条记录吗？');">
