<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\xiaoshi\code\day09\xm\kedu\kedu\public/../application/admin\view\user\add.html";i:1524538486;s:78:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\layout.html";i:1524529658;s:76:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\menu.html";i:1524537907;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="page-content" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo url('User/add'); ?>" method="post" name="myfrom" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="name" placeholder="请输入用户名"/>
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="user_name" placeholder="请输入真实姓名"/>
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="password" name="password" placeholder="请输入密码" class="col-xs-10 col-sm-5" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="id_number" placeholder="请输入身份证号"/>
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="tel" placeholder="请输入电话"/>
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="email" class="col-xs-10 col-sm-5" name="email" placeholder="请输入邮箱号"/>
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="pw_question" placeholder="请输入密码问题"/>
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="pw_answer" placeholder="请输入密码答案"/>
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="addr" placeholder="请输入详细地址"/>
                    </div>
                </div>
                <div class="space-4"></div>
