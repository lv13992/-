<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"D:\xiaoshi\code\day09\xm\kedu\kedu\public/../application/admin\view\user_feedback\index.html";i:1524203509;s:78:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\layout.html";i:1524529658;s:76:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\menu.html";i:1524537907;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="col-xs-12">
                    <table id="simple-table" class="table  table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="hidden-480">留言类型</th>
                            <th class="hidden-480" style="width: 250px">留言内容</th>
                            <th class="hidden-480">留言图片</th>
                            <th>
                        ...
                        <tr>
                            ...
                            <td class="hidden-480"><?php echo $vo['user_email']; ?></td>
                            <td><?php echo $vo['feedback_title']; ?></td>
                            <td><?php echo $vo['feedback_type']===0?'建议':'投诉'; ?></td>
                            <td><?php echo $vo['feedback_content']; ?></td>
                            <td><img src="/static/upload/admin/<?php echo $vo['feedback_img']; ?>" alt="" width="50px"></td>
                            <td><?php echo date('Y-m-d H:i:s',$vo['feedback_time'] ); ?></td>
                            <td>
                                <?php echo $vo['order_id']===0?'未回复':'已回复'; ?>
                            </td>
                            <td>
