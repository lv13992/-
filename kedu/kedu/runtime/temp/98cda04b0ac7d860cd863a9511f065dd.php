<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\xiaoshi\code\day09\xm\kedu\kedu\public/../application/admin\view\user_comment\edit.html";i:1524055449;s:78:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\layout.html";i:1524529658;s:76:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\menu.html";i:1524529726;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="page-content">
    <div class="col-sm-6 pull-right">
        <a class="btn btn-sm btn-primary pull-right" href="<?php echo url('index'); ?>">
            返回列表
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="" method="post" name="myfrom" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="user_id" value="<?php echo (isset($data['user_id']) && ($data['user_id'] !== '')?$data['user_id']:''); ?>" disabled="true"/>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">评论类型</label>
                    <div class="col-sm-9">
                        <input type="text" disabled="true" class="col-xs-10 col-sm-5" value="<?php echo (isset($data['comment_type']) && ($data['comment_type'] !== '')?$data['comment_type']:''); ?>" name="comment_type"/>
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 文章/商品名 </label>

                    <div class="col-sm-9">
                        <input type="text" name="id_value" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo (isset($data['id_value'] ) && ($data['id_value']  !== '')?$data['id_value'] :''); ?>" disabled="true"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="email" value="<?php echo (isset($data['email']) && ($data['email'] !== '')?$data['email']:''); ?>" disabled="disabled"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="content" id="" cols="30" rows="10" class="" disabled="true"><?php echo (isset($data['content']) && ($data['content'] !== '')?$data['content']:''); ?></textarea>
                    </div>
                </div>
                <div class="space-4"></div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="radio" name="status" value="0" checked>未批准
                        <input type="radio" name="status" value="1" <?php if($data['status'] == 1): ?>checked<?php endif; ?>>已批准
                    </div>
                </div>
