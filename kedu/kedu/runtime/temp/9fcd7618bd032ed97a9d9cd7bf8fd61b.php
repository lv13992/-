<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"D:\xiaoshi\code\day09\xm\kedu\kedu\public/../application/admin\view\user_account\recycle.html";i:1524444394;s:78:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\layout.html";i:1524529658;s:76:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\menu.html";i:1524537907;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs btn-group">
                                    <a href='<?php echo url("UserAccount/restore",["id"=>$vo['id']]); ?>'>
                                            <span class="btn btn-xs btn-info">
                                                <i class="ace-icon fa fa-recycle bigger-120">还原</i>
                                            </span>
                                    </a>

                                    <a href='javascript:void(0)' onclick="return alert_del('<?php echo url("del",["id"=>$vo['id']]); ?>', '若要删除『 id=<?php echo $vo['id']; ?> 』将不可恢复！！？');">
