<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\xiaoshi\code\day09\xm\kedu\kedu\public/../application/admin\view\goodsbrand\index.html";i:1524482752;s:78:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\layout.html";i:1524529658;s:76:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\menu.html";i:1524537263;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="col-xs-12">
                    <table id="simple-table" class="table  table-bordered table-hover">
                        ...
                        <tr align="left">
                            ...
                            <td><a href="/uploads/<?php echo $vo['brand_img']; ?>" target="_blank"><img src="/static/image/picflag.gif" alt=""></a></td>
                            <td><?php echo $vo['brand_desc']; ?></td>
                            <td><a href="<?php echo $vo['site_url']; ?>"><?php echo $vo['site_url']; ?></a></td>

                            <td class="hidden-480">
                                <span class="label label-sm label-warning"><?php echo $vo['is_show']; ?></span>
                            </td>

                            <td>
                                <div class="hidden-sm hidden-xs btn-group">

                                    <a href='<?php echo url("edit","id=$vo[brand_id]"); ?>'
                                    <span class="btn btn-xs btn-info">
                                                <i class="ace-icon fa fa-pencil bigger-120"></i>
                                            </span>
                                    </a>
                                    <a href='javascript:void(0)' onclick="return alert_del('<?php echo url("del","id=$vo[brand_id]"); ?>', '确认要删除『 id=<?php echo $vo['brand_id']; ?> 』这条记录吗？');"
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            <li>
                                                <a href='<?php echo url("edit","id=$vo[brand_id]"); ?>' class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                            ...
                                            <li>
                                                <a href='javascript:void(0)' onclick="return alert_del('<?php echo url("del","id=$vo[brand_id]"); ?>', '确认要删除『 id=<?php echo $vo['brand_id']; ?> 』这条记录吗？');" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                <span class="red">
                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                        </span>
                                                </a>
