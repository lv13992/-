<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\xiaoshi\code\day09\xm\kedu\kedu\public/../application/admin\view\user\index.html";i:1524482752;s:78:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\layout.html";i:1524529658;s:76:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\menu.html";i:1524537907;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="page-content">
    <div class="col-sm-6 pull-right">
        <span class="btn btn-sm btn-primary pull-right" onclick="javascript:window.location.href = 'add'">
            添加
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table id="simple-table" class="table  table-bordered table-hover" align="center">
                        <thead>
                        <tr>
                            <th class="center">
                                <label class="pos-rel">
                        ...
                        <tr>
                            ...
                            <td><a href="#"><?php echo $vo['user_grade_id']; ?></a></td>
                            <td><?php echo $vo['name']; ?></td>
                            <td class="hidden-480"><?php echo $vo['user_name']; ?></td>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs btn-group">
                                    ...
                                    <a href='javascript:void(0)' onclick="return alert_del('<?php echo url("delete","id=$vo[id]"); ?>', '确认要删除『 id=<?php echo $vo['id']; ?> 』这条记录吗？');"
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            <div>
                                                <li>
                                                <a href='<?php echo url("save","id=$vo[id]"); ?>' class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                            ...
                                            <div>
                                                <li>
                                                    <a href='javascript:void(0)' onclick="return alert_del('<?php echo url("delete","id=$vo[id]"); ?>', '确认要删除『 id=<?php echo $vo['id']; ?> 』这条记录吗？');" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                    <span class="red">
                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                        </span>
                                                    </a>
