<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\xiaoshi\code\day09\xm\kedu\kedu\public/../application/admin\view\recycler\index.html";i:1524446647;s:78:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\layout.html";i:1524529658;s:76:"D:\xiaoshi\code\day09\xm\kedu\kedu\application\admin\view\template\menu.html";i:1524537263;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="page-content">
    ...
    <form action="<?php echo url('Recycler/mutildel'); ?>" method="post" enctype="multipart/form-data" id="form-product">
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <div class="row">
                    <div class="col-xs-12">
                        <table id="simple-table" class="table  table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class=" btn-group">
                                        <a href="<?php echo URL('Recycler/recover',['id'=>$vo['id']]); ?>">
                                    ...
                                    <div class=" btn-group">
                                        <a href='javascript:void(0)' onclick="return alert_del('<?php echo url("Recycler/delete","id=$vo[id]"); ?>', '确认要删除『 id=<?php echo $vo['id']; ?> 』这条记录吗？');"
                                        <span class="btn btn-xs btn-danger pull-right bigger-110">
